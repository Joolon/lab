...
class Consumer3 extends Consumer{
    ...
    public function doProcess($msg){
        ...
        file_put_contents("d:/test_consumer_3.log", date('Y-m-d H:i:s').$msg.PHP_EOL,FILE_APPEND);
        echo $msg."\n";
    }
}
$consumer = new Consumer3($rb_conf,$exchangeName,$queueName,$routingKey,'direct');
//$consumer->run(false);
$consumer->run(true);
