...
<body>
    <div>
    <h1 class="ui-title"> YIBAI TECHNOLOGY LTD采购合同</h1>
    <div class="ui-box">
        <table class="ui-basicInformation">
            ...
            <tr class="ui-purchase-num-tr" v-for="(item, index) in compact_details">
                <td class="ui-quarter-td"><?php echo $sku_data[0]['purchase_number']?></td>
                <td><?php echo $sku_data[0]['sku']?></td>
                <td><?php echo $sku_data[0]['product_name']?></td>
                <td class="ui-quarter-td"><?php echo $sku_data[0]['purchase_unit_price']?></td>
                <td class="ui-one-eight-td"><?php echo $sku_data[0]['purchase_amount']?></td>
                <td class="ui-one-eight-td"><?php echo $sku_data[0]['sku_total_price']?></td>
            ...
            <tr class="ui-contract-content">
                <td colspan="8">一、当满足以下条件之一时，甲方可安人员排对产品及乙方的生产进行稽核，并对乙方提出生产改善建议。</td>
            </tr>
            <tr class="ui-contract-content">
    ...
    <style>
        ...
        .ui-purchase-num-tr .ui-one-eight-td-img {
            min-width: 40px;
            height: 40px;
        }
