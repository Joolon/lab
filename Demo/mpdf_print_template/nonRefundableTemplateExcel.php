...
$data_json        = $redis->get($key.'ntax_compact_excel'.'-'.$compact_number);
...
<div>
    <div class="ui-box">
        <table class="ui-basicInformation">
            ...
            <tr>
                <td class="ui-half-td ui-font-weight" colspan='5'>甲方信息</td>
            ...
            <tr class="ui-purchase-num-tr">
                ...
                <td class="ui-quarter-td ui-font-weight">规格</td>
                ...
                <?php } ?>
                <!-- <td class="ui-one-eight-td ui-font-weight">开票点</td> -->
            ...
            foreach ($sku_data as $key => $value_list){
                ...
                foreach($value_list as $value){
                    ...
                    <tr class="ui-purchase-num-tr">
                        <?php if($num ==1){ ?>
                            <td class="ui-quarter-td" style="width: 100px;border-bottom-style:none;" ><?php echo $value['purchase_number'] ?></td>
                        <?php }else{ ?>
                        ...
                        <td style="width: 100px;" class="ui-quarter-td"><?php echo mb_str_split($value['sku_spec'])?></td>
                        ...
                        <?php if($switch_show_image != 2) { ?>
                        <td class="ui-one-eight-td-img"><img src="<?php echo $value['product_img_url'] ?>" width="40" height="40"></td>
                        <?php } ?>
...
//                        $tail_money = bcsub($compact_data['product_money'], bcsub($cancel_total_real_money, $dj, 3), 3);
            ...
            <!--                <td colspan='6'>供应商开具此合同等同金额增值税专用发票，发票可用作出口退税使用。</td>-->
            ...
            <tr class="ui-summary-title">
                ...
                <td colspan='10' class="ui-contract-content">如乙方有知悉或怀疑甲方员工有索要回扣等商业贿赂行为，可与甲方联系，联系人：易佰网络投诉建议中心， 举报电话：18165762495 （微信同号），举报邮箱：3004486039@qq.com。甲方会对所有信息提供者及所提供的全部资料严格保密。
                </td>
            </tr>

            <tr class="ui-summary-title">
                <td><p style="line-height: 20px;">汇款信息</p></td>
                <td colspan='10' class="ui-contract-content"><?php echo $compact_data['remit_information'] ?></td>
            </tr>
            ...
            <!--
            <tr >
                <td colspan='10' class="ui-contract-content">经检验当满足以下条件之一时，甲方有权拒收产品：</td>
            </tr>
            <tr >
                <td colspan='10' class="ui-contract-content">1、甲方正常提出验货，乙方拒不配合。</td>
            </tr>
            <tr >
                <td colspan='10' class="ui-contract-content">2、甲方在检验过程中，不良品超出AQL验收标准，乙方拒不全检。</td>
            </tr>
            <tr >
                <td colspan='10' class="ui-contract-content">3、甲方在检验过程中，不良品未超出AQL验收标准，乙方拒不更换不良品。</td>
            </tr>
            <tr >
                <td colspan='10' class="ui-contract-content">4、甲方提出改善建议，并与乙方达成一致后，再次订货乙方未将改善方案实施。</td>
            </tr>
            -->
            <tr >
