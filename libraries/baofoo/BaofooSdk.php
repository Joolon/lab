...
if ( !function_exists( 'hex2bin' ) ) {
 ...
 class BaofooSdk{
     ...
     */
    public function Verification($member_id=100000178, $terminal_id=100000859, $data_type='json', $private_key_password='123456') {
        $path = $_SERVER['DOCUMENT_ROOT'];
	$path .= "/end/libraries/baofoo/cer/";
        $private_key_path=$path.'m_pri.pfx';
        $public_key_path=$path.'baofoo_pub.cer';
